...
static void select_col(uint8_t col) { gpio_write_pin_high(col_pins[col]); }

static void unselect_col(uint8_t col) { gpio_write_pin_low(col_pins[col]); }
...
static void select_row(uint8_t row) { gpio_write_pin_high(row_pins[row]); }

static void unselect_row(uint8_t row) { gpio_write_pin_low(row_pins[row]); }
